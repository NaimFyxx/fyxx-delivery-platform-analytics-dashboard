...
export const EXPLAINERS: Record<string, Explainer> = {
  ...
  best_ever: {
    label: "Best ever",
    meaning:
      "The best month on record for this metric, across the full history. Higher is better for sales, profit, orders and margin; lower is better for discounting and commission drag. Either way it reads Best ever and always names what it beat, so the claim is checkable.",
